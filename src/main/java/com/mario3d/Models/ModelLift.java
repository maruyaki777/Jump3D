...
import com.mario3d.CubeEntity.Lift;
...
public class ModelLift implements Model{
    ...
    private static final int[][][][] tex = ModelTexArray.set(
        new ModelCubeTex(0, 0, 20, 5, 20)
    );

    private final Lift entity;
    private FPSBufferStream<WorldPosition> WP_fpsbuffer;

    public ModelLift(Lift entity) {
        this.entity = entity;
    ...
    //テクスチャ
    private static Texture texture = Textures.Loader.getTexture("entity", "lift");
