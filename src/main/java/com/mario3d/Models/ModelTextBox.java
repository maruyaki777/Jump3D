...
import com.mario3d.CubeEntity.MessageBox;
...
public class ModelTextBox implements Model{
    ...
    private static final int[][][][] tex = ModelTexArray.set(
        ...
        private final MessageBox entity;

    public ModelTextBox(MessageBox entity) {
        this.entity = entity;
    }
